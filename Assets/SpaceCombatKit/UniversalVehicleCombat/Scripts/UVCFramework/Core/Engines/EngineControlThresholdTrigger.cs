...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class EngineControlThresholdTrigger : MonoBehaviour
    {
        ...
        {
            previousMovementInputs = engines.MovementInputs;
            previousSteeringInputs = engines.SteeringInputs;
            previousBoostInputs = engines.BoostInputs;
        }
        ...
        protected virtual void OnMovementInputsChanged()
        {
            ...
            {
                if (CheckThreshold(engines.MovementInputs.x, previousMovementInputs.x))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
            ...
            {
                if (CheckThreshold(engines.MovementInputs.y, previousMovementInputs.y))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
            ...
            {
                if (CheckThreshold(engines.MovementInputs.z, previousMovementInputs.z))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
        ...
        protected virtual void OnSteeringInputsChanged()
        {
            ...
            if (axis == Axis.X || axis == Axis.Any)
            {
                if (CheckThreshold(engines.SteeringInputs.x, previousSteeringInputs.x))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
            ...
            if (axis == Axis.Y || axis == Axis.Any)
            {
                if (CheckThreshold(engines.SteeringInputs.y, previousSteeringInputs.y))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
            ...
            if (axis == Axis.Z || axis == Axis.Any)
            {
                if (CheckThreshold(engines.SteeringInputs.z, previousSteeringInputs.z))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
        ...
        protected virtual void OnBoostInputsChanged()
        {
            ...
            if (axis == Axis.X || axis == Axis.Any)
            {
                if (CheckThreshold(engines.BoostInputs.x, previousBoostInputs.x))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
            ...
            if (axis == Axis.Y || axis == Axis.Any)
            {
                if (CheckThreshold(engines.BoostInputs.y, previousBoostInputs.y))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
            ...
            if (axis == Axis.Z || axis == Axis.Any)
            {
                if (CheckThreshold(engines.BoostInputs.z, previousBoostInputs.z))
                {
                    UpdateStoredValues();
                    Trigger();
                    return;
