...
namespace Christina.GameSystems
{
    ...
    {
        //reference to the damage text, font size, crit font size, color
        [Header("Damage Label")] 
